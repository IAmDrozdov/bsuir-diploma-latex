...
Программное обеспечение, разрабатываемое в рамках дипломного проекта для автоматизации автоматизации процесса сдачи в аренду товаров позволяет безопасно сдавать собственные вещи в аренду физическим лицам. В качестве аналога можно рассматривать сервисы для продажи вещей физическими лицами. Также за счет модульности данного программного обеспечения, а именно предоставления базовых операций, над товарами и модуля аутентификации пользователей данное приложение можно использовать как подсистему в программный продуктах.
Программное обеспечение обеспечивает выполнение следующих функций:
Регистрация пользователя в приложении;
Размещение товаров для сдачи в аренду;
Покупка товаров в аренду;
Контроль за перемещаемыми товарами со стороны администратора;
Отслеживание статуса сданного товара в аренду.
Разработка и внедрение данного программного обеспечения позволит ускорить поиск товара, за счет унификации трафика товаров, уменьшить количество нелегальных сделок.
	...
	Программное обеспечение обеспечит прирост прибыли за счет комиссии, взимаемой при оплате покупки товара в аренду. Также данное программное обеспечение можно использовать для создания платформы для контроля сдачи в аренду конкретного типа товаров, урезав спектр продуктов, доступных для оборота.
